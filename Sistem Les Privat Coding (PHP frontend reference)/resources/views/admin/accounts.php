<div class="flex flex-col gap-6">
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Kelola akun Murid dan Pengajar</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md border border-green-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 text-sm font-medium">Akun Aktif</p>
                    <p class="text-3xl font-bold text-green-600 mt-2">172</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md border border-red-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 text-sm font-medium">Akun Nonaktif</p>
