<div class="flex flex-col gap-6">
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Kelola paket les dengan jumlah pertemuan dan harga tetap</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md border border-emerald-100 p-6">
            ...
            <p class="text-xs text-emerald-600 mt-3 font-medium">Sedang digunakan murid</p>
        </div>

        <div class="bg-white rounded-lg shadow-md border border-purple-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 text-sm font-medium">Paket Terlaris</p>
                    <p class="text-xl font-bold text-purple-600 mt-2">8 Pertemuan</p>
                </div>
            ...
            <p class="text-xs text-purple-600 mt-3 font-medium">45 pembelian bulan ini</p>
        </div>
