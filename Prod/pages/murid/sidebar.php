...
<div class="sidebar poppins-regular">
    ...
    <a href="paketSaya.php" class="<?php if(basename($_SERVER['PHP_SELF'], ".php") == "paketSaya") echo "active"; ?>">
        Paket Saya
    </a>

    <a href="pilihJadwal.php" class="<?php if(basename($_SERVER['PHP_SELF'], ".php") == "pilihJadwal") echo "active"; ?>">
        Pilih Jadwal
    </a>

    <a href="jadwalLes.php" class="<?php if(basename($_SERVER['PHP_SELF'], ".php") == "jadwalLes") echo "active"; ?>">
        Jadwal Les
    </a>

    <a href="kehadiran.php" class="<?php if(basename($_SERVER['PHP_SELF'], ".php") == "kehadiran") echo "active"; ?>">
        Riwayat Kehadiran
    </a>
